...
class SignUpPage {
    ...
    registrationErrorLocator = '//div[contains(text(), "use in everyday life, what their friends call them, on Facebook. ")]';
    ...
    async isRegistrationErrorDisplayed() {
        await this.commands.isWebElementEnabled(this.registrationErrorLocator);
    }
 }
